        ...
        <Router>
          <React.Fragment>
            ...
            <Switch>
              ...
              <Route exact path='/admin/posts/new' component={AdminWrapper(Page)} />
              <Route exact path='/admin/posts/:postId' component={AdminWrapper(Page)} />
              <Route exact path='/admin/comments' component={AdminWrapper(Page)} />
              <Route exact path='/admin/users' component={AdminWrapper(Page)} />
              <Route exact path='/admin/users/:userId' component={AdminWrapper(Page)} />
            </Switch>
          </React.Fragment>
        </Router>
      </Provider>
